...
class RRAPET(Frame):
    ...
    def __init__(self, parent):
        ...
        self.ftypes = [('All files', '*'), ('Text files', '*.txt'), ('HDF5 files', '*.h5'), ('MAT files', '*.mat'),
                       ('WFDB files', '*.dat')]
        self.openicon = ImageTk.PhotoImage(Image.open('Pics/open24.png'))
        self.saveicon = ImageTk.PhotoImage(Image.open('Pics/savemet24.png'))
        self.saveicon2 = ImageTk.PhotoImage(Image.open('Pics/saveRT24.png'))
        self.updateicon = ImageTk.PhotoImage(Image.open('Pics/update24.png'))
        self.settingsicon = ImageTk.PhotoImage(Image.open('Pics/settings24.png'))
        self.closeicon = ImageTk.PhotoImage(Image.open('Pics/close24.png'))
        self.calcicon = ImageTk.PhotoImage(Image.open('Pics/calc24.png'))
        self.helpicon = ImageTk.PhotoImage(Image.open('Pics/help24.png'))
        self.editicon = ImageTk.PhotoImage(Image.open('Pics/edit24.png'))
        self.photo = ImageTk.PhotoImage(Image.open('Pics/darrow16.png'))
        self.dacontrols = ImageTk.PhotoImage(Image.open('Pics/settings24.png'))
        self.batch = ImageTk.PhotoImage(Image.open('Pics/batch24.png'))
        self.initUI()
        pad = 0
